<?php
// admin_stats_fixed.php: Fixed admin dashboard statistics endpoint
// Replace admin_stats.php with this file

// Enable detailed error logging
ini_set('display_errors', 0); // Don't display errors to browser
ini_set('log_errors', 1);
ini_set('error_log', __DIR__ . '/admin_stats_fixed_error.log');
