<?php
/**
 * approve_kyc.php: Handles admin approval of KYC submissions
...
try {
    ...
    $stmt = $pdo->prepare("UPDATE kyc_requests SET status='approved', updated_at=NOW() WHERE id=?");
    ...
    echo json_encode(["success" => true, "message" => "KYC submission approved successfully"]);
} catch (Exception $e) {
